...
struct reg_value1 regs_values1[REGS_VALUES1_SIZE] = {
    (struct reg_value1) {
        BME680_TEMP_PAR_T1_LSB, {{243}, {243}, {243}, {243}, {243}, {243}, {243}}
    },
    (struct reg_value1) {
        BME680_TEMP_PAR_T1_MSB, {{101}, {101}, {101}, {101}, {101}, {101}, {101}}
    },
    (struct reg_value1) {
        BME680_TEMP_PAR_T2_LSB, {{85}, {85}, {85}, {85}, {85}, {85}, {85}}
    },
    (struct reg_value1) {
        BME680_TEMP_PAR_T2_MSB, {{103}, {103}, {103}, {103}, {103}, {103}, {103}}
    },
    (struct reg_value1) {
        BME680_TEMP_PAR_T3, {{3}, {3}, {3}, {3}, {3}, {3}, {3}}
    },
    (struct reg_value1) {
        BME680_HUM_PAR_H1_LSB, {{55}, {55}, {55}, {55}, {55}, {55}, {55}}
    },
    (struct reg_value1) {
        BME680_HUM_PAR_H1_MSB, {{67}, {67}, {67}, {67}, {67}, {67}, {67}}
    },
    (struct reg_value1) {
        BME680_HUM_PAR_H2_MSB, {{59}, {59}, {59}, {59}, {59}, {59}, {59}}
    },
    (struct reg_value1) {
        BME680_HUM_PAR_H3, {{0}, {0}, {0}, {0}, {0}, {0}, {0}}
    },
    (struct reg_value1) {
        BME680_HUM_PAR_H4, {{45}, {45}, {45}, {45}, {45}, {45}, {45}}
    },
    (struct reg_value1) {
        BME680_HUM_PAR_H5, {{20}, {20}, {20}, {20}, {20}, {20}, {20}}
    },
    (struct reg_value1) {
        BME680_HUM_PAR_H6, {{120}, {120}, {120}, {120}, {120}, {120}, {120}}
    },
    (struct reg_value1) {
        BME680_HUM_PAR_H7, {{156}, {156}, {156}, {156}, {156}, {156}, {156}}
    },
    (struct reg_value1) {
        BME680_PRESS_PAR_P1_LSB, {{244}, {244}, {244}, {244}, {244}, {244}, {244}}
    },
    (struct reg_value1) {
        BME680_PRESS_PAR_P1_MSB, {{143}, {143}, {143}, {143}, {143}, {143}, {143}}
    },
    (struct reg_value1) {
        BME680_PRESS_PAR_P2_LSB, {{217}, {217}, {217}, {217}, {217}, {217}, {217}}
    },
    (struct reg_value1) {
        BME680_PRESS_PAR_P2_MSB, {{215}, {215}, {215}, {215}, {215}, {215}, {215}}
    },
    (struct reg_value1) {
        BME680_PRESS_PAR_P3, {{88}, {88}, {88}, {88}, {88}, {88}, {88}}
    },
    (struct reg_value1) {
        BME680_PRESS_PAR_P4_LSB, {{6}, {6}, {6}, {6}, {6}, {6}, {6}}
    },
    (struct reg_value1) {
        BME680_PRESS_PAR_P4_MSB, {{43}, {43}, {43}, {43}, {43}, {43}, {43}}
    },
    (struct reg_value1) {
        BME680_PRESS_PAR_P5_LSB, {{215}, {215}, {215}, {215}, {215}, {215}, {215}}
    },
    (struct reg_value1) {
        BME680_PRESS_PAR_P5_MSB, {{254}, {254}, {254}, {254}, {254}, {254}, {254}}
    },
    (struct reg_value1) {
        BME680_PRESS_PAR_P6, {{30}, {30}, {30}, {30}, {30}, {30}, {30}}
    },
    (struct reg_value1) {
        BME680_PRESS_PAR_P7, {{48}, {48}, {48}, {48}, {48}, {48}, {48}}
    },
    (struct reg_value1) {
        BME680_PRESS_PAR_P8_LSB, {{132}, {132}, {132}, {132}, {132}, {132}, {132}}
    },
    (struct reg_value1) {
        BME680_PRESS_PAR_P8_MSB, {{242}, {242}, {242}, {242}, {242}, {242}, {242}}
    },
    (struct reg_value1) {
        BME680_PRESS_PAR_P9_LSB, {{37}, {37}, {37}, {37}, {37}, {37}, {37}}
    },
    (struct reg_value1) {
        BME680_PRESS_PAR_P9_MSB, {{247}, {247}, {247}, {247}, {247}, {247}, {247}}
    },
    (struct reg_value1) {
        BME680_PRESS_PAR_P10, {{30}, {30}, {30}, {30}, {30}, {30}, {30}}
    },
    (struct reg_value1) {
        BME680_ID, {{0}, {0}, {0}, {0}, {0}, {0}, {0}}
    }
...
struct reg_value2 regs_values2[REGS_VALUES2_SIZE] = {
    (struct reg_value2) {
        BME680_HUM_ADC_MSB, {{92, 213}, {92, 213}, {92, 213}, {92, 213}, {92, 213}, {92, 213}, {92, 213}}
    }
};

struct reg_value3 regs_values3[REGS_VALUES3_SIZE] = {
    (struct reg_value3) {
        BME680_TEMP_ADC_MSB, {{122, 125, 144}, {122, 125, 144}, {122, 125, 144}, {122, 125, 144}, {122, 125, 144}, {122, 125, 144}, {122, 125, 144}}
    },
    (struct reg_value3) {
        BME680_PRESS_ADC_MSB, {{65, 154, 224}, {65, 154, 224}, {65, 154, 224}, {65, 154, 224}, {65, 154, 224}, {65, 154, 224}, {65, 154, 224}}
    }
};
