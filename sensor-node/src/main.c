...
void read_all_sensor_values() {
    ...
    memset(&context.mem[SENSOR_NODE_TEMP], 0, sizeof(int32_t));
    memset(&context.mem[SENSOR_NODE_HUM], 0, sizeof(int32_t));
    memset(&context.mem[SENSOR_NODE_PRESS], 0, sizeof(int32_t));
